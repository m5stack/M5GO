...
class MPU6050:
    ...
    def __init__(
        ...
        # if 0x75 != self.whoami:
        #     raise RuntimeError("MPU6050 not found in I2C bus.")
    ...
    def init(self):
        self._register_char(0x6B, 0x01)
        self._register_char(0x1A, 0x03)
        self._register_char(0x19, 0x04)

        self._register_char(0x19, 0x04)
        c = self._register_char(0x1B)
        self._register_char(0x1C, c & ~0xE0)
        self._register_char(0x1C, c & ~0x18)
        self._register_char(0x1C, c)

        self._register_char(0x37, 0x22)
        self._register_char(0x38, 0x01)
        pass
